...
class MapViewController: UIViewController{
    ...
    var managedObjectContext: NSManagedObjectContext!{
        didSet{
            NotificationCenter.default.addObserver(forName: Notification.Name.NSManagedObjectContextObjectsDidChange, object: managedObjectContext, queue: OperationQueue.main, using: { //object: 发出noti的对象
                notification in
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "EditLocation"{
            ...
            controller.locationToEdit = locations[(sender as! UIButton).tag]
